angular.module("gulpAngularDemo.code").service("AlertService", ["$http", "$document", "$q", "$rootScope", "$compile", function ($http, $document, $q, $rootScope, $compile) {
    var zIndex = 1200;
    var dialogCounter = 0;
    ...
    function getTemplate() {
        ...
        if (dialogTpl) {
            ...
            $http.get("assets/alert/alert.html").then(function (result) {
